...
public class WeatherApiController {
    ...
    private String [] areaNames = {"서울", "부산", "대구", "대전", "광주", "울산", "인천"};
    private int [] xList = {60, 97, 88, 67, 57, 103, 50};
    private int [] yList = {126, 76, 89, 102, 74, 83, 127};

    public List<String> weather() throws Exception {
        String resultObject = "";
