    ...
    ;function Places(b) {
        ...
        this.keywordSearch = function(b, g, e) {
            ...
            var f = KeywordSearch(b, function(a, b) {
                $("#map").before(`
                    <div id="loading" style="width: 100vw; height: 100vh; position: relative; background-color: white; display: flex; text-align: center; justify-content: center; color: black;">
                        ...
                        <img style="margin-top: 50vh; width: 100px; height: 100px;" src="/img/spinner.gif">
                    </div>
                `);
        ...
        this.keywordSearchAll = function(b, g, e) {
            ...
            var f = KeywordSearch(b, function(a, b) {
                ...
                if (a) {
                    ...
                    let accidents = [];
                    $.ajax({
                        url: "http://localhost/apis/queryall.do",
                        type: "GET",
                        origin: "http://127.0.0.1:3000",
                        success: function(result) {
                            for(let i=0; i<result.length; i++){
